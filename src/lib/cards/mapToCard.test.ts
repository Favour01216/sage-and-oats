...
describe('ensureHttps', () => {
  it('converts http to https', () => {
    expect(ensureHttps('http://www.edamam.com/image.jpg'))
      .toBe('https://www.edamam.com/image.jpg');
  });

  it('leaves https unchanged', () => {
    expect(ensureHttps('https://www.edamam.com/image.jpg'))
      .toBe('https://www.edamam.com/image.jpg');
  });
...
describe('cleanTitle', () => {
  ...
  it('cleans URL titles using source URL', () => {
    expect(cleanTitle('http://example.com/recipe', 'http://foodblog.com/recipe'))
      .toBe('Recipe from foodblog.com');
  });

  it('cleans URL titles without source URL', () => {
    expect(cleanTitle('https://example.com/recipe'))
      .toBe('Recipe');
  });

  it('removes www from domain', () => {
    expect(cleanTitle('http://bad', 'http://www.foodblog.com/recipe'))
      .toBe('Recipe from foodblog.com');
  });
