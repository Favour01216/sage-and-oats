  ...
  return (
    <div className="flex items-center gap-3">
      ...
      <ClearRefinements
        classNames={{
          root: 'shrink-0',
          button: 'px-4 py-2 text-sm border border-border dark:border-border-dark rounded-lg hover:bg-muted/10 transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary/50',
        }}
      />
    </div>
  )
