...
const recipes = [
  {
    ...
    ingredients: [
      {
        group_label: null,
        line_text: "1 whole chicken (4 lbs)",
        quantity_num: 1,
        unit: "whole",
        item: "chicken",
      },
      ...
      {
        group_label: null,
        line_text: "4 garlic cloves, minced",
        quantity_num: 4,
        unit: null,
        item: "garlic cloves",
      },
      ...
      {
        group_label: null,
        line_text: "Fresh rosemary and thyme",
        quantity_num: null,
        unit: null,
        item: "herbs",
      },
      {
        group_label: null,
        line_text: "Salt and pepper to taste",
        quantity_num: null,
        unit: null,
        item: "seasonings",
      },
    ...
    steps: [
      {
        step_number: 1,
        text: "Preheat oven to 425°F (220°C). Pat chicken dry with paper towels.",
        timer_seconds: null,
      },
      {
        step_number: 2,
        text: "Mix olive oil, minced garlic, and chopped herbs in a bowl.",
        timer_seconds: null,
      },
      {
        step_number: 3,
        text: "Rub the herb mixture all over the chicken, including under the skin.",
        timer_seconds: null,
      },
      {
        step_number: 4,
        text: "Stuff the cavity with lemon halves and extra herbs.",
        timer_seconds: null,
      },
      {
        step_number: 5,
        text: "Roast for 1 hour 15 minutes until golden and internal temp reaches 165°F.",
        timer_seconds: 4500,
      },
  ...
  },
  {
    ...
    ingredients: [
      ...
      {
        group_label: null,
        line_text: "8 oz mixed mushrooms, sliced",
        quantity_num: 8,
        unit: "oz",
        item: "mushrooms",
      },
      {
        group_label: null,
        line_text: "4 cups vegetable broth, warm",
        quantity_num: 4,
        unit: "cups",
      ...
      {
        group_label: null,
        line_text: "1 onion, finely diced",
        quantity_num: 1,
        unit: null,
        item: "onion",
      },
    ...
    steps: [
      {
        step_number: 1,
        text: "Sauté mushrooms in 1 tbsp butter until golden. Set aside.",
        timer_seconds: null,
      },
      {
        step_number: 2,
        text: "In the same pan, sauté onion until translucent.",
        timer_seconds: null,
      },
      {
        step_number: 3,
        text: "Add rice and toast for 2 minutes, stirring constantly.",
        timer_seconds: 120,
      },
      { step_number: 4, text: "Add wine and stir until absorbed.", timer_seconds: null },
      {
        step_number: 5,
        text: "Add broth one ladle at a time, stirring until absorbed before adding more.",
        timer_seconds: 1200,
      },
      {
        step_number: 6,
        text: "Stir in mushrooms, remaining butter, and parmesan. Season to taste.",
        timer_seconds: null,
      },
    ],
    nutrition: {
  ...
  },
  {
    ...
    ingredients: [
      ...
      {
        group_label: null,
        line_text: "2 cups mixed vegetables",
        quantity_num: 2,
        unit: "cups",
        item: "vegetables",
      },
      {
        group_label: null,
        line_text: "1 block firm tofu, cubed",
        quantity_num: 1,
        unit: "block",
        item: "tofu",
      },
    ...
    steps: [
      {
        step_number: 1,
        text: "Heat oil in a large pan and fry curry paste for 1 minute.",
        timer_seconds: 60,
      },
      { step_number: 2, text: "Add coconut milk and bring to a simmer.", timer_seconds: null },
      {
        step_number: 3,
        text: "Add tofu and harder vegetables, simmer for 10 minutes.",
        timer_seconds: 600,
      },
      {
        step_number: 4,
        text: "Add remaining vegetables and cook for 5 more minutes.",
        timer_seconds: 300,
      },
      {
        step_number: 5,
        text: "Stir in soy sauce, sugar, and basil leaves. Serve with rice.",
        timer_seconds: null,
      },
    ],
    nutrition: {
...
async function seedDatabase() {
  ...
  for (const recipeData of recipes) {
    ...
    const { error: stepsError } = await supabase.from("recipe_steps").insert(stepsWithRecipeId);
