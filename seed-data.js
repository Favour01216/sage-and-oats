  ...
  for (const recipe of recipes) {
    ...
    const ingredientSets = {
      ...
      'creamy-mushroom-risotto': [
        { line_text: '1½ cups arborio rice', quantity_num: 1.5, unit: 'cups', item: 'arborio rice' },
        { line_text: '1 lb mixed mushrooms, sliced', quantity_num: 1, unit: 'lb', item: 'mushrooms' },
        { line_text: '4 cups vegetable broth', quantity_num: 4, unit: 'cups', item: 'vegetable broth' },
        { line_text: '1 cup white wine', quantity_num: 1, unit: 'cup', item: 'white wine' },
        { line_text: '1 cup parmesan cheese, grated', quantity_num: 1, unit: 'cup', item: 'parmesan' },
        { line_text: '2 tbsp butter', quantity_num: 2, unit: 'tbsp', item: 'butter' }
      ],
      'thai-green-curry': [
        { line_text: '2 tbsp green curry paste', quantity_num: 2, unit: 'tbsp', item: 'curry paste' },
        { line_text: '1 can (14 oz) coconut milk', quantity_num: 14, unit: 'oz', item: 'coconut milk' },
        ...
        { line_text: '2 tbsp fish sauce (or soy sauce)', quantity_num: 2, unit: 'tbsp', item: 'fish sauce' },
    ...
    const stepSets = {
      ...
      'creamy-mushroom-risotto': [
        ...
        { step_number: 5, text: 'Add broth one ladle at a time, stirring constantly.', timer_seconds: 1200 },
