...
async function seedDatabase() {
  ...
  for (const recipe of recipes) {
    ...
    if (error) {
      ...
      const ingredients = [
        { recipe_id: data.id, line_text: '2 cups main ingredient', quantity_num: 2, unit: 'cups', item: 'main ingredient' },
        { recipe_id: data.id, line_text: '1 tbsp olive oil', quantity_num: 1, unit: 'tbsp', item: 'olive oil' },
      ...
      const steps = [
        ...
        { recipe_id: data.id, step_number: 2, text: 'Cook according to recipe', timer_seconds: 600 },
